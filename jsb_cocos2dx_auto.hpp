...
JSBool js_cocos2dx_Director_setKeypadDispatcher(JSContext *cx, uint32_t argc, jsval *vp);
...
JSBool js_cocos2dx_Director_setTouchDispatcher(JSContext *cx, uint32_t argc, jsval *vp);
