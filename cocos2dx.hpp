...
JSBool js_cocos2dx_CCControl_needsLayout(JSContext *cx, uint32_t argc, jsval *vp);
JSBool js_cocos2dx_CCControl_hasVisibleParents(JSContext *cx, uint32_t argc, jsval *vp);
